...
async def get_lender_detail_admin(
    ...
    return {
        ...
        "verified_at": lender.verified_at.isoformat() if getattr(lender, "verified_at", None) else None,
        "verified_by": str(lender.verified_by) if getattr(lender, "verified_by", None) else None,
